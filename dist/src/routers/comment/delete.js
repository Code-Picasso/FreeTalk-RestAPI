...
router.delete("./api/comment/:commentIddelete/:postId", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { postId, commentId } = req.params;
    if (!postId || !commentId) {
        const error = new Error("Post id is and comment id is required");
        error.status = 400;
        next(error);
    }
    try {
